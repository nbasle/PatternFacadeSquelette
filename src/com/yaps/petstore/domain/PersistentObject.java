...
import com.yaps.petstore.uidgen.UniqueIdGenerator;
...
public abstract class PersistentObject extends DomainObject implements Serializable {
     ...
     * Because this method is specific to every class, it is abstract.
     ...
     */
    public abstract void findByPrimaryKey(final String id) throws FinderException, CheckException;
